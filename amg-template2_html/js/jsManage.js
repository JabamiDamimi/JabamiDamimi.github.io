...
$(function() {
    ...
    function mobile() {
        ...
        if (menuBtn.is(':hidden')) {
            ...
            $('.inquiry').prependTo(menuGroup).children('a').text('');
            $('.menu-search').children('a').text('');
            ...
            $('.inquiry').appendTo(menuMain).children('a').text('Inquiry');
            $('.menu-search').children('a').text('Search');

            if (menuMain.find('.sitemap').length === 0 ) { 
                menuMain.append('<li class="sitemap"><a href="sitemap.html">Sitemap</a></li>'); 
            }
